...
def generate_file():
    ...
    with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
        ...
        f.write("# ship — causes the loadout screen to malfunction.\n")
        f.write("PLAYER_START_WING_NAMES = {\"Alpha\", \"Beta\", \"Gamma\"}\n\n")
        f.write("# Broader set of canonical/common FreeSpace wing names drawn from\n")
        f.write("# the FreeSpace Universe Bible (Terran, Vasudan, and Shivan canonical names).\n")
        f.write("# Used ONLY for the advisory standalone ship name-pattern warning.\n")
        f.write("# Does NOT affect conversion logic or loadout validation.\n")
        f.write("COMMON_WING_NAMES = {\n")
        f.write("    # Terran friendly\n")
        f.write("    \"Alpha\", \"Beta\", \"Gamma\", \"Delta\", \"Epsilon\", \"Zeta\", \"Eta\",\n")
        f.write("    # Terran enemy\n")
        f.write("    \"Bragi\", \"Buri\", \"Freki\", \"Geri\", \"Hrid\", \"Roskva\", \"Scald\", \"Skadi\",\n")
        f.write("    # Vasudan friendly\n")
        f.write("    \"Theta\", \"Iota\", \"Kappa\", \"Lambda\", \"Mu\", \"Nu\", \"Xi\", \"Omicron\", \"Pi\", \"Rho\", \"Sigma\",\n")
        f.write("    # Vasudan enemy\n")
        f.write("    \"Aquarius\", \"Aries\", \"Cancer\", \"Capricorn\", \"Gemini\", \"Leo\", \"Libra\",\n")
        f.write("    \"Pisces\", \"Sagittarius\", \"Scorpio\", \"Taurus\", \"Virgo\",\n")
        f.write("    # Shivan enemy\n")
        f.write("    \"Brahma\", \"Vishnu\", \"Durga\", \"Rama\", \"Krishna\", \"Indra\", \"Arjuna\",\n")
        f.write("    \"Deva\", \"Bheema\", \"Kali\", \"Genma\", \"Asura\",\n")
        f.write("}\n\n")
