...
1. Open the NeuralFS folder with Visual Studio Code. The Roo Code extension should automatically load the three AI agent definitions (defined in the `.roomodes` file).
...
3. Replace the `<campaign_folder>` placeholder in the prompt with the name of the campaign folder created by the creative writing agent.
