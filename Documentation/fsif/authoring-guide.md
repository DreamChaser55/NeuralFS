...
- Do not put `arrival_location`, `arrival_anchor`, `arrival_distance`, `arrival_delay`, `arrival_cue`, `departure_location`, `departure_anchor`, `departure_cue`, or `ai_goals` into `entities.ship_templates`. For standalone ships, author them on the ship; for wing members, author them on the wing.
