...
class AsciiChecksMixin:
    ...
    def validate_ascii_text_fields(self):
        ...
        for i, ship in enumerate(self.mission.ships):
            ...
            self._validate_ascii_text(f'{prefix}.arrival_condition', ship.arrival_condition)
            ...
            self._validate_ascii_text(f'{prefix}.departure_condition', ship.departure_condition)
        ...
        for i, wing in enumerate(self.mission.wings):
            ...
            self._validate_ascii_text(f'{prefix}.arrival_condition', wing.arrival_condition)
            ...
            self._validate_ascii_text(f'{prefix}.departure_condition', wing.departure_condition)
