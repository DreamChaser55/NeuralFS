...
# ---------------------------------------------------------------------------
# Inworld TTS optional-dependency tests
# ---------------------------------------------------------------------------

class InworldOptionalDependencyTesting(unittest.TestCase):
    ...
    def test_is_available_returns_false_when_requests_is_none(self):
        ...
        try:
            tts_inworld.requests = None
            # Bypass __init__ to test is_available() in isolation without
            # triggering the constructor's ImportError guard.
    ...
    def test_tts_inworld_module_can_always_be_imported(self):
        ...
        # If we reach this line, the import at the top of this test module
        # (via 'import tts_inworld' in the test methods above) has already
        # succeeded.  Re-import via importlib to confirm idempotency.
        import importlib
        import tts_inworld
